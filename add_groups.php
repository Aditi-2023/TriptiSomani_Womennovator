...
session_start();
   ...
   $GetDetailByid=$driverObj->GetDetailsByid(base64_decode($_GET['eid']),'group');
  
   $employee_data=$driverObj->getalltable('group');
   //echo "<pre>"; print_r($employee_data);die; 
if(isset($_GET["did"]))
{
    $result=$med_common_Obj->DeleteDataById($_GET["did"],'group');
    if($result>0)
    {
      header("Location:add_groups.php?msg=ds");
    }
    else
    {
      header("Location:add_groups.php?msg=df");
    }
}

   if(isset($_POST["Add"]))
   {
     echo  $result=$driverObj->AddGroup($_POST);
       if($result>0)
       {
         header("Location:add_groups.php?msg=ins");
       }
       else
       {
         header("Location:add_groups.php?msg=inf");
       }
   }
   if(isset($_POST["update"]))
   {
       $result=$driverObj->UpdateGroup($_POST);
       if($result>0)
       {
         header("Location:add_groups.php?msg=ups");
       }
       else
       {
         header("Location:add_groups.php?msg=upf");
       }
                                 ...
                                 <div class="">
                                    ...
                                    <form class="row" method="POST"  enctype="multipart/form-data" >
                                       ...
                                       <div class="col-md-6">
                                        ...
                                        <input type="hidden" name="page_bg" value="our_future">

                                          <label for="vehicle_make" class="">Group Name</label> 

                                             <div class="input-group">

                                              <input type="text" class="form-control" name="group_name" required=""

                                               value="<?php echo $GetDetailByid['group_name'];?>"> 
                                   ...
                                   <div class="col-md-6">
                                            ...
                                            <label for="vehicle_make" class=""> Image</label> 
                                             ...
                                             <div class="input-group">
                                                ...
                                                <input type="file" class="form-control" name="image">
                                                  ...
                                                  if(!empty($GetDetailByid['image'])){

                                               echo'<input type="hidden" name="image_h" value="'.$GetDetailByid['image'].'">';
                                               }
                          if(!empty($GetDetailByid['image']))

                                                {

                                                echo'<img src="../photos/'.$GetDetailByid['image'].'" style="width:50px;">';
 ...
 <div class="card">
                                            ...
                                            ?>
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                  ...
                                                  <img src="../photos/<?=$value['image'];?>" style="width:50px;">
   ...
   <script type="text/javascript">
...

      {
        ...
        window.location.href='add_groups.php?eid='+id
...

{
  ...
  window.location.href='add_groups.php?did='+id
...

{
  ...
  window.location.href='add_groups.php?a_id='+window.btoa(id) + "&val=" + window.btoa(value);
