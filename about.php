...
?>
   ...
   <div class="section-parallax" style="background-image: url(img/images/12.jpg);background-position: center;">
    ...
    <div id="enterpreneur" style="position: relative;top: -100px;"></div>
    <div class="section-site p-0" style="background: #d4e8ff;">
        <div class="row g-0">
            <div class="col-md-5 mb-md-0 mb-4">
                <img src="img/potrait2.jpeg" class="w-100" style="height: 100%;object-fit: cover;object-position: right;">
            </div>
            <div class="col-md-7">
                <div class="px-md-5 px-4 py-4" style="">
    ...
    <div id="strategist" style="position: relative;top: -100px;"></div>
    <div class="section-site p-0" style="background: #fff;">
        <div class="row g-0">
            <div class="col-md-7">
                <div class="px-md-5 px-4 py-4" style="">
                    <div class="text-start">
            ...
            <div class="col-md-5 mb-md-0 mb-4">
                <img src="img/images/4.jpg" class="w-100" style="height: 100%;object-fit: cover;">
            </div>
        </div>
    </div>
    
    <div id="mentor" style="position: relative;top: -100px;"></div>
    <div class="section-site p-0" style="background: #ffe5d4;">
        <div class="row g-0">
            <div class="col-md-5 mb-md-0 mb-4">
                <img src="img/images/13.jpg" class="w-100" style="height: 100%;object-fit: cover;">
            </div>
            <div class="col-md-7">
                <div class="px-md-5 px-4 py-4" style="">
                    <div class="text-start">
    ...
    <div id="policy-changemaker" style="position: relative;top: -100px;"></div>
    <div class="section-site p-0" id="policy-changemaker" style="background: #fff;">
        <div class="row g-0">
            <div class="col-md-7">
                <div class="px-md-5 px-4 py-4" style="">
                    <div class="text-start">
            ...
            <div class="col-md-5 mb-md-0 mb-4">
                <img src="img/images/5.jpg" class="w-100" style="height: 100%;object-fit: cover;object-position: right;">
            </div>
        </div>
    </div>
