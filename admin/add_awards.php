...
error_reporting(1);
   ...
   $GetDetailByid=$driverObj->GetDetailsByid(base64_decode($_GET['eid']),'tbl_awardes');
  
   $employee_data=$driverObj->getalltable('tbl_awardes');
   //echo "<pre>"; print_r($employee_data);die; 
if(isset($_GET["did"]))
{
    $result=$med_common_Obj->DeleteDataById($_GET["did"],'tbl_awardes');
    if($result>0)
    {
      header("Location:add_awards.php?msg=ds");
    }
    else
    {
      header("Location:add_awards.php?msg=df");
    }
}

 if(isset($_POST["Add"]))
   {
     echo  $result=$driverObj->AddawardGroup($_POST);
       if($result>0)
       {
         header("Location:add_awards.php?msg=ins");
       }
       else
       {
         header("Location:add_awards.php?msg=inf");
       }
   }
 
    if(isset($_POST["update"]))
   {
       $result=$driverObj->Updateaward($_POST);
       if($result>0)
       {
         header("Location:add_awards.php?msg=ups");
       }
       else
       {
         header("Location:add_awards.php?msg=upf");
       }
                  ...
                  <div class="card">
                     ...
                     <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                        ...
                        <div class="d-flex justify-content-between">
                           ...
                           <h4 class="card-title mb-0">Add New Awards</h4>
...
<div class="col-md-3">
<label for="vehicle_make" class="">Description</label> 
...
<td>
   ...
   <script type="text/javascript">
...

      {
        ...
        window.location.href='add_awards.php?eid='+id
...

{
  ...
  window.location.href='add_awards.php?did='+id
...

{
  ...
  window.location.href='add_awards.php?a_id='+window.btoa(id) + "&val=" + window.btoa(value);
