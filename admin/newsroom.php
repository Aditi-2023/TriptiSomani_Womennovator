...
error_reporting(1);
   ...
   $employee_data=$driverObj->getalltable1('tbl_newroom','1');
...
if(isset($_GET["did"]))
{
    ...
    if($result>0)
    {
      header("Location:newsroom.php?msg=ds");
    }
    else
    {
      header("Location:newsroom.php?msg=df");
    }
}
 ...
 if(isset($_POST["Add"]))
   {
     echo  $result=$driverObj->Addnewroom($_POST);
       if($result>0)
       {
         header("Location:newsroom.php?msg=ins");
       }
       else
       {
         header("Location:newsroom.php?msg=inf");
       }
   }
    ...
    if(isset($_POST["update"]))
   {
       ...
       if($result>0)
       {
         header("Location:newsroom.php?msg=ups");
       }
       else
       {
         header("Location:newsroom.php?msg=upf");
       }
...
<label for="vehicle_make" class="">Title</label> 
							...
							<input type="hidden" name="newroom" value="1" class="form-control">
											  </div>
...
<td>
   ...
   <script type="text/javascript">
...

      {
        ...
        window.location.href='newsroom.php?eid='+id
...

{
  ...
  window.location.href='newsroom.php?did='+id
...

{
  ...
  window.location.href='newsroom.php?a_id='+window.btoa(id) + "&val=" + window.btoa(value);
