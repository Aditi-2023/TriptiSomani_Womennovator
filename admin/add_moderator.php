...
error_reporting(1);
   ...
   $GetDetailByid=$driverObj->GetDetailsByid(base64_decode($_GET['eid']),'tbl_gallery');
  
   $employee_data=$driverObj->getalltable('tbl_gallery');
   //echo "<pre>"; print_r($employee_data);die; 
if(isset($_GET["did"]))
{
    $result=$med_common_Obj->DeleteDataById($_GET["did"],'tbl_gallery');
    if($result>0)
    {
      header("Location:add_moderator.php?msg=ds");
    }
    else
    {
      header("Location:add_moderator.php?msg=df");
    }
}
 ...
 if(isset($_POST["Add"]))
   {
     echo  $result=$driverObj->AddGroup($_POST);
       if($result>0)
       {
         header("Location:add_moderator.php?msg=ins");
       }
       else
       {
         header("Location:add_moderator.php?msg=inf");
       }
   }
    ...
    if(isset($_POST["update"]))
   {
       ...
       if($result>0)
       {
         header("Location:add_moderator.php?msg=ups");
       }
       else
       {
         header("Location:add_moderator.php?msg=upf");
       }
                  ...
                  <div class="card">
                     ...
                     <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                        ...
                        <div class="d-flex justify-content-between">
                           ...
                           <h4 class="card-title mb-0">Add New Gellary</h4>
...
<td>
   ...
   <script type="text/javascript">
...

      {
        ...
        window.location.href='add_moderator.php?eid='+id
...

{
  ...
  window.location.href='add_moderator.php?did='+id
...

{
  ...
  window.location.href='add_moderator.php?a_id='+window.btoa(id) + "&val=" + window.btoa(value);
